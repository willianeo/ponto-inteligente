...
export class ListagemComponent implements OnInit {
  ...
  // manter o estado do último funcionário selecionado
  get funcId(): string {
      ...
      .subscribe(
        data => {
          ...
          this.funcionarios = (data.data as Funcionario[])
            .filter(func => func.id != usuarioId); // não exibi registros do administrador logado.
  ...
  remover(lancamentoId: string) {
    this.lancamentosService.remover(lancamentoId)
      .subscribe(
        data => {
